...
import com.example.tezmarket.data.remote.model.advertisements.Data
import okio.IOException
import retrofit2.HttpException

class AdvertisementsPagingSource(private val tezMarketApi: TezMarketApi) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Data> {
        return try {
            ...
            val response = tezMarketApi.getAdvertisements(page = nextPage).body()
            LoadResult.Page(
